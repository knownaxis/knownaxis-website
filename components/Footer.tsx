...
export default function Footer() {
  return (
    <footer id="contact" className="relative border-t border-line/40 bg-[#07080b] pt-16 sm:pt-20 text-[#cfd0d4] overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 sm:mt-5 max-w-xl text-[14.5px] sm:text-[16px] text-grey leading-relaxed">
          ...
          <div className="mt-8 sm:mt-9 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            <a
              href="#cases"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-full border border-line bg-white/5 px-7 py-3.5 sm:py-4 text-[14px] sm:text-[14.5px] font-medium text-white hover:bg-white/10 transition-colors"
            >
              Explore Our Work
            </a>
          </div>
        ...
        <div className="grid gap-10 border-b border-line/50 pb-12 sm:pb-16 grid-cols-2 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div className="col-span-2 md:col-span-1">
            <div className="mb-4 flex items-center gap-2 text-lg font-bold text-white tracking-wide">
              <span className="h-3 w-3 rounded-sm bg-brand shadow-sm shadow-brand" />
              KNOWNAXIS
            </div>
            <p className="max-w-sm text-[13px] sm:text-[13.5px] leading-relaxed text-[#8a8c92]">
            ...
            <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] text-grey">
          ...
          <div>
            <h4 className="mb-4 text-xs font-semibold uppercase tracking-wider text-white">Capabilities</h4>
            <div className="flex flex-col gap-2.5 text-[13.5px] text-[#8a8c92]">
              <a href="#services" className="hover:text-white transition-colors">3D Web Engineering</a>
              <a href="#services" className="hover:text-white transition-colors">Brand Identity & UI/UX</a>
              <a href="#services" className="hover:text-white transition-colors">Custom AI Automation</a>
              <a href="#services" className="hover:text-white transition-colors">Conversion Optimization</a>
            </div>
          </div>
          ...
          <div>
            <h4 className="mb-4 text-xs font-semibold uppercase tracking-wider text-white">Legal & Connect</h4>
            <div className="flex flex-col gap-2.5 text-[13.5px] text-[#8a8c92]">
              ...
              <a href="mailto:hello@knownaxis.com" className="hover:text-white transition-colors">hello@knownaxis.com</a>
            </div>
          </div>
        </div>

        {/* Copyright & Social Row */}
        <div className="flex flex-col items-center justify-between gap-4 py-8 text-[12.5px] text-[#6f7178] md:flex-row">
